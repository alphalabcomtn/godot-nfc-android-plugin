...
class CardLogic {
    ...
    public static final String patternsJSONMinimize = "\"([a-zA-Z0-9]*)\":";
    public static final String patternsJSONMinimizeReplacement = "$1:";
    public static final String patternsJSONMaximize = "([a-zA-Z]*):";
    public static final String patternsJSONMaximizeReplacement = "\"$1\":";

    public final static String NFC_tappy = "a";
    public final static String NFC_apps = "b";
    public final static String NFC_owner = "c";
    public final static String NFC_id = "d";
    public final static String NFC_areaId = "e";
    public final static String NFC_guestId = "f";
    public final static String NFC_checkin = "g";
    public final static String NFC_checkout = "h";
    public final static String NFC_checkinCount = "i";
    public final static String NFC_checkoutCount = "j";
    public final static String NFC_checkinDate = "k";
    public final static String NFC_checkoutDate = "l";
    public final static String NFC_balance = "m";
    private static Object mString;
     ...
     */
    String desfireLightCardLogic(Activity activity, IDESFireLight idesFireLight) {
        byte[] appDFName =
        ...
        try {
            ...
            stringBuilder.append(activity.getString(R.string.File_IDs)).append(str).append(
                    activity.getString(R.string.LINE_BREAK));
            Key keyDefault = new SecretKeySpec(Constants.KEY_AES128_DEFAULT, "AES");
            ...
            stringBuilder.append(Constants.UNABLE_TO_READ).append(
                    activity.getString(R.string.LINE_BREAK));
        }
     ...
     */
    String plusSL3CardLogic(Activity activity, IPlusSL3 plusSL3) {
...
//                 ALL WORK RELATED TO MIFARE PLUS SL3 card.
                plusSL3.authenticateFirst(0x4004, Constants.objKEY_AES128, pcdCap2In);
                stringBuilder.append(activity.getString(R.string.UID)).append(
    ...
    String plusEV1SL3CardLogic(Activity activity, IPlusEV1SL3 plusEV1SL3) {
...
//             ALL WORK RELATED TO MIFARE PLUS EV1 SL3 card. using EV1 secure messaging
            plusEV1SL3.authenticateFirst(0x4006, Constants.objKEY_AES128, pcdCap2In);
            ...
            stringBuilder.append(Constants.UNABLE_TO_READ).append(activity.getString(R.string.LINE_BREAK));
        }
        return stringBuilder.toString();
    }
     ...
     */
    String ultralightEV1CardLogic(Activity activity, IUltralightEV1 ultralightEV1) {
...
//             connect to card, authenticate and read data
     ...
     */
    String ultralightcCardLogic(Activity activity, IUltralightC ultralightC) {
        ...
        try {
            ...
            kd.setKey(new SecretKeySpec("alphalabalphalab".getBytes(), "DESede"));
            ultralightC.authenticate(kd);
            stringBuilder.append(activity.getString(R.string.Auth_success)).append(
                    activity.getString(R.string.LINE_BREAK));
            String data = new String(ultralightC.readAll());
            try {
                data = data.substring(16, data.lastIndexOf("}") + 1);
                Log.e("ALPHA", "DATA BEFORE:" + data);
                data = data.replaceAll(patternsJSONMaximize, patternsJSONMaximizeReplacement);
                Log.e("ALPHA", "DATA AFTER:" + data);
            ...
            stringBuilder.append(activity.getString(R.string.Data_read_from_the_card)).append(
                    activity.getString(R.string.LINE_BREAK)).append(
                    data).append(
                    activity.getString(R.string.LINE_BREAK));
     ...
     */
    String ultralightCardLogic(Activity activity, IUltralight ultralightObj) {
     ...
     */
    String ultralightAESCardLogic(Activity activity, IUltralightAES ultralightAES) {
        stringBuilder.delete(0, stringBuilder.length());
        stringBuilder.append(activity.getString(R.string.Card_Detected)).append(
    ...
    String ultralightNanoCardLogic(Activity activity, UltralightNano ultralightNano) {
     ...
     */
    String plusSL1CardLogic(Activity activity, IPlusSL1 plusSL1) {
        stringBuilder.delete(0, stringBuilder.length());
        stringBuilder.append(activity.getString(R.string.Card_Detected)).append(
        ...
        int blockTorw = Constants.DEFAULT_SECTOR_CLASSIC;
        int sectorOfBlock;
        try {
            stringBuilder.append(activity.getString(R.string.UID)).append(
            ...
            plusSL1.authenticateSectorWithKeyA(sectorOfBlock, Constants.default_ff_key);
            stringBuilder.append(activity.getString(R.string.Auth_success)).append(
                    activity.getString(R.string.LINE_BREAK));
    ...
    String plusEV1SL1CardLogic(Activity activity, IPlusEV1SL1 plusEV1SL1) {
        stringBuilder.delete(0, stringBuilder.length());
        int sectorOfBlock;
        try {
            stringBuilder.append(activity.getString(R.string.Card_Detected)).append(
            ...
            sectorOfBlock = plusEV1SL1.blockToSector(Constants.DEFAULT_SECTOR_CLASSIC);
            plusEV1SL1.authenticateSectorWithKeyA(sectorOfBlock, Constants.default_ff_key);
            stringBuilder.append(activity.getString(R.string.Auth_success)).append(
                    activity.getString(R.string.LINE_BREAK));
            ...
            Log.w(Constants.TAG, activity.getString(R.string.Exception_performing_operation_on_plusEV1SL1)
                    + e.getMessage());
            stringBuilder.append(Constants.UNABLE_TO_READ).append(activity.getString(R.string.LINE_BREAK));
     ...
     */
    String classicCardLogic(Activity activity, IMFClassic mifareClassic) {
        stringBuilder.delete(0, stringBuilder.length());
        stringBuilder.append(activity.getString(R.string.Card_Detected)).append(
        ...
        try {
            ...
            sectorOfBlock = mifareClassic.blockToSector(Constants.DEFAULT_SECTOR_CLASSIC);
            mifareClassic.authenticateSectorWithKeyA(sectorOfBlock,
                    Constants.default_ff_key);
            stringBuilder.append(activity.getString(R.string.Auth_success)).append(
                    activity.getString(R.string.LINE_BREAK));
     ...
     */
    String classicCardEV1Logic(Activity activity, IMFClassicEV1 mifareClassicEv1) {
        stringBuilder.delete(0, stringBuilder.length());
        stringBuilder.append(activity.getString(R.string.Card_Detected)).append(
        ...
        try {
            ...
            sectorOfBlock = mifareClassicEv1.blockToSector(Constants.DEFAULT_SECTOR_CLASSIC);
  ...
  */
    String desfireEV1CardLogic(Activity activity, IDESFireEV1 desFireEV1) {
    ...
    String desfireEV2CardLogic(Activity activity, IDESFireEV2 desFireEV2) {
        int timeOut = 2000;
        stringBuilder.delete(0, stringBuilder.length());
        stringBuilder.append(activity.getString(R.string.Card_Detected)).append(
    ...
    String tag424DNATTCardLogic(Activity activity, INTAG424DNATT ntag424DNATT) {
    ...
    String ntag413CardLogic(Activity activity, final INTag413DNA tag) {
        byte[] DF =
        ...
        try {
            ...
            tag.authenticateFirst(0, Constants.default_zeroes_key, new byte[]{});
            stringBuilder.append(activity.getString(R.string.Auth_success)).append(
                    activity.getString(R.string.LINE_BREAK));
    ...
    String ntag213TTCardLogic(Activity activity, final INTag213TagTamper tag) {
        stringBuilder.delete(0, stringBuilder.length());
        stringBuilder.append(activity.getString(R.string.Card_Detected)).append(
                tag.getType().getTagName()).append(activity.getString(R.string.LINE_BREAK));
    ...
    String ntagCardLogic(Activity activity, final INTag tag) {
 ...
 */
    ...
    String iCodeSLISCardLogic(Activity activity, IICodeSLIS icodeSLIS) {
        ...
        try {
            ...
            out = icodeSLIS.readSingleBlock(ICode.NFCV_FLAG_ADDRESS, Constants.DEFAULT_ICode_PAGE);
            if (out != null) {
                stringBuilder.append(activity.getString(R.string.Data_read_from_block)).append(
                        " ").append(
                        Constants.DEFAULT_ICode_PAGE).append(": ").append(
    ...
    String iCodeSLICardLogic(Activity activity, IICodeSLI icodeSLI) {
        ...
        try {
            ...
            out = icodeSLI.readSingleBlock(ICode.NFCV_FLAG_ADDRESS, Constants.DEFAULT_ICode_PAGE);
            if (out != null) {
                stringBuilder.append(activity.getString(R.string.Data_read_from_block)).append(
                        " ").append(
                        Constants.DEFAULT_ICode_PAGE).append(": ").append(
     ...
     * card logic.
     */
    String iCodeSLILCardLogic(Activity activity, IICodeSLIL icodeSLIL) {
        ...
        try {
            ...
            out = icodeSLIL.readSingleBlock(ICode.NFCV_FLAG_ADDRESS, Constants.DEFAULT_ICode_PAGE);
            if (out != null) {
                stringBuilder.append(activity.getString(R.string.Data_read_from_block)).append(
                        " ").append(
                        Constants.DEFAULT_ICode_PAGE).append(": ").append(
     ...
     * card logic.
     */
    String iCodeSLIXCardLogic(Activity activity, IICodeSLIX icodeSLIX) {
        ...
        try {
            ...
            out = icodeSLIX.readSingleBlock(ICode.NFCV_FLAG_ADDRESS, Constants.DEFAULT_ICode_PAGE);
            if (out != null) {
                stringBuilder.append(activity.getString(R.string.Data_read_from_block)).append(
                        " ").append(
                        Constants.DEFAULT_ICode_PAGE).append(": ").append(
     ...
     * card logic.
     */
    String iCodeSLIXSCardLogic(Activity activity, IICodeSLIXS icodeSLIXS) {
        ...
        try {
            ...
            out = icodeSLIXS.readSingleBlock(ICode.NFCV_FLAG_ADDRESS, Constants.DEFAULT_ICode_PAGE);
            if (out != null) {
                stringBuilder.append(activity.getString(R.string.Data_read_from_block)).append(
                        " ").append(
                        Constants.DEFAULT_ICode_PAGE).append(": ").append(
    ...
    String iCodeSLIXLCardLogic(Activity activity, IICodeSLIXL icodeSLIXL) {
        ...
        try {
            ...
            out = icodeSLIXL.readSingleBlock(ICode.NFCV_FLAG_ADDRESS, Constants.DEFAULT_ICode_PAGE);
            if (out != null) {
                stringBuilder.append(activity.getString(R.string.Data_read_from_block)).append(
                        " ").append(
                        Constants.DEFAULT_ICode_PAGE).append(": ").append(
     ...
     * card logic.
     */
    String iCodeSLIX2CardLogic(Activity activity, IICodeSLIX2 icodeSLIX2) {
        byte[] out;
        stringBuilder.delete(0, stringBuilder.length());
        stringBuilder.append(activity.getString(R.string.Card_Detected)).append(
        ...
        try {
            ...
            out = icodeSLIX2.readSingleBlock(ICode.NFCV_FLAG_ADDRESS, Constants.DEFAULT_ICode_PAGE);
            if (out != null) {
                stringBuilder.append(activity.getString(R.string.Data_read_from_block)).append(
                        " ").append(
                        Constants.DEFAULT_ICode_PAGE).append(": ").append(
    ...
    String iCodeDNACardLogic(Activity activity, IICodeDNA icodeDNA) {
        byte[] out;
        stringBuilder.delete(0, stringBuilder.length());
        stringBuilder.append(activity.getString(R.string.Card_Detected)).append(
        ...
        try {
            ...
            out = icodeDNA.readSingleBlock(ICode.NFCV_FLAG_ADDRESS, Constants.DEFAULT_ICode_PAGE);
            if (out != null) {
                stringBuilder.append(activity.getString(R.string.Data_read_from_block)).append(
                        " ").append(
                        Constants.DEFAULT_ICode_PAGE).append(": ").append(
